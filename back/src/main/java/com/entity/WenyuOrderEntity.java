...
public class WenyuOrderEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public WenyuOrderEntity() {

	}

	public WenyuOrderEntity(T t) {
		try {
    ...
    @TableField(value = "wenyu_order_uuid_number")
     ...
     * 文娱活动
     */
    @ColumnInfo(comment="文娱活动",type="int(11)")
    @TableField(value = "wenyu_id")
    ...
    @TableField(value = "wenyu_order_types")
    ...
    public String toString() {
        return "WenyuOrder{" +
            ", id=" + id +
            ", wenyuOrderUuidNumber=" + wenyuOrderUuidNumber +
            ", wenyuId=" + wenyuId +
            ", yonghuId=" + yonghuId +
            ", buyNumber=" + buyNumber +
