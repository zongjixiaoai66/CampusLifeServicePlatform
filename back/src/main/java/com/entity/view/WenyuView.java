...
*/
@TableName("wenyu")
public class WenyuView extends WenyuEntity implements Serializable {
	...
	*/
	...
	public WenyuView(WenyuEntity wenyuEntity) {
		try {
			BeanUtils.copyProperties(this, wenyuEntity);
