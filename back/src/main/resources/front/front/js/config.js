...
var centerMenu = [
    ...
    ,{
        name: '跑腿接单',
        url: '../paotuiOrder/list.html'
    }
    ,{
        name: '备忘录',
        url: '../beiwanglu/list2.html'
    },{
        name: '文娱活动报名',
        url: '../wenyuOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '跑腿',
        url: './pages/paotui/list.html'
    },
    {
        name: '文娱活动',
        url: './pages/wenyu/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/xyshfwpt/admin/dist/index.html#/login";
