        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xyshfwpt/upload/beiwangluMuBan.xls"
                        >批量导入备忘录数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('beiwanglu','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="beiwangluUuidNumber"
                                   header-align="center"
                                   label="备忘录编号">
                        <template slot-scope="scope">
                            {{scope.row.beiwangluUuidNumber}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                id : null,
                beiwangluName : null,
                beiwangluUuidNumber : null,
                beiwangluContent : null,
                beiwangluDelete : null,
                insertTime : null,
                createTime : null,
            },
            dataList: [],
